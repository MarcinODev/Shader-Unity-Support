...
/// <summary>
/// Handles braces matching and higligting
/// </summary>
public class BraceMatchingTagger : ITagger<TextMarkerTag>
{
    ...
    public IEnumerable<ITagSpan<TextMarkerTag>> GetTags(NormalizedSnapshotSpanCollection spans)
    {
        ...
        if(m_braceList.ContainsKey(currentText))   //the key is the open brace
        {
            ...
            {
                yield return new TagSpan<TextMarkerTag>(new SnapshotSpan(currentChar, 1), new TextMarkerTag("Keyword"));
                yield return new TagSpan<TextMarkerTag>(pairSpan, new TextMarkerTag("Keyword"));
            }
        }
        else if(m_braceList.ContainsValue(lastText))    //the value is the close brace, which is the *previous* character 
        {
            ...
            {
                yield return new TagSpan<TextMarkerTag>(new SnapshotSpan(lastChar, 1), new TextMarkerTag("Keyword"));
                yield return new TagSpan<TextMarkerTag>(pairSpan, new TextMarkerTag("Keyword"));
            }
        }
    }
